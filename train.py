...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    last = wdir / 'last.pt'
    best = wdir / 'best.pt'
    results_file = Path('/content/drive/MyDrive/DP/results') / 'results.txt'
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if rank in [-1, 0]:
                ...
                # Plot
                if plots and ni < 3:
                    f = Path('/content/drive/MyDrive/DP/results') / f'train_batch{ni}.jpg'  # filename
...
if __name__ == '__main__':
    ...
    if opt.resume:  # resume an interrupted run
        ...
        opt.save_dir = increment_path(Path('/kaggle/working/ScaledYOLOv4/runs/train/yolov4-csp2/') / opt.name, exist_ok=opt.exist_ok | opt.evolve)  # increment run
