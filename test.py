...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/coco-local.yaml', help='*.data path')
    parser.add_argument('--batch-size', type=int, default=16, help='size of each image batch')
    parser.add_argument('--img-size', type=int, default=576, help='inference size (pixels)')
